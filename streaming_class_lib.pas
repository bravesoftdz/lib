...
TstreamingClass=class(TComponent)
  ...
  public
    ...
    function FindOwner: TComponent; //доходит до самого высокого уровн€
...
// пожалуй, не стоит. ≈сли нам это так важно, то добавим отдельным property!
//      saveFormat:=fAscii;
    end
    else begin
...
begin
  ...
  //первоначальное состо€ние
  //InitInstance(self);
  //заполн€ет все нул€ми, булевы значение в false, указатели в nil.
  //об€зательно в начале Clear в производном классе надо вызвать
  //inherited
end;
*)
