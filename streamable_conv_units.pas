...
begin
  ...
  cbCyrVoltage:=RegisterConversionFamily('Напряжение');
  ...
  cbCyrPower:=RegisterConversionFamily('Мощность');
  powWatt:=RegisterConversionType(cbPower,'W',1);
  powCyrWatt:=RegisterConversionType(cbPower,'Вт',1);
  powmW:=RegisterConversionType(cbPower,'mW',1e-3);
  powCyrmW:=RegisterConversionType(cbPower,'мВт',1e-3);
  powuW:=RegisterConversionType(cbPower,'uW',1e-6);
  powCyruW:=RegisterConversionType(cbPower,'мкВт',1e-6);
  powkW:=RegisterConversionType(cbPower,'kW',1000);
  powCyrkW:=RegisterConversionType(cbPower,'кВт',1000);
  powMegaW:=RegisterConversionType(cbPower,'Megawatt',1e6);
  powCyrMegaW:=RegisterConversionType(cbPower,'Мегаватт',1e6);
  ...
  RegisterConversionType(cbForce,'uН',1e-6);
  RegisterConversionType(cbForce,'nН',1e-9);
  RegisterConversionType(cbForce,'pН',1e-12);
  RegisterConversionType(cbForce,'kН',1e3);
  RegisterConversionType(cbForce,'MegaН',1e6);
  ...
  RegisterConversionType(cbEnergy,'кДж',1000);
  RegisterConversionType(cbEnergy,'MegaJ',1e6);
  RegisterConversionType(cbEnergy,'МегаДж',1e6);
  RegisterConversionType(cbEnergy,'mJ',1e-3);
  RegisterConversionType(cbEnergy,'мДж',1e-3);
  RegisterConversionType(cbEnergy,'uJ',1e-6);
  RegisterConversionType(cbEnergy,'мкДж',1e-6);
  RegisterConversionType(cbEnergy,'nJ',1e-6);
  RegisterConversionType(cbEnergy,'нДж',1e-6);
  RegisterConversionType(cbEnergy,'pJ',1e-9);
  RegisterConversionType(cbEnergy,'пДж',1e-9);
